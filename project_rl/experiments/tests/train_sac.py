...
from project_rl.algos import SACLearner
from project_rl.algos.sac.buffer import ReplayBuffer
from project_rl.experiments.evaluate import evaluate
from project_rl.envs import make_env


FLAGS = flags.FLAGS

flags.DEFINE_string('env_name', 'HalfCheetah-v2', 'Environment name.')
flags.DEFINE_string('save_dir', '/tmp/mydir', 'Tensorboard logging dir.') # storage node on cluster.
